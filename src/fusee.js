...
// // var shipper = ship.getBoundingClientRect();
// console.log(ship);
// var x = ship.offset();
// console.log(x);
// addDust(20);
...
//     if (keys[38]) { // weapon 9
//         shipper.y -= 5;
//         shipper.style.top = shipper.y + 'px';
//         console.log(shipper);
//       }

//   })
//   .on('keydown', function(event) {
//     // let road = $('#environment').getBoundingClientRect();
//     // if(keys.ArrowUp && ship.y > road.top){player.y -= player.speed;}
//     // if(keys.ArrowDown && ship.y < road.bottom){player.y += player.speed;}
//     // if(keys.ArrowLeft && ship.x > 0){player.x -= player.speed;}
//     // if(keys.ArrowRight && ship.x < (road.width-20)){player.x += player.speed;}
//     // posX = (event.offsetX);
//     // posY = (event.offsetX);
//     // console.log(event);
//     // ship.css({left: posX,top: posY});
//   })
// ;
